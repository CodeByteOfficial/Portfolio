    ...
    <section className={styles.container}>
        <div className={styles.content}>
            ...
            <div className={styles.btnContainer}>
              <a className={styles.contactBtn} href="mailto:official.harsh1407@gmail.com">Contact</a>
            <a className={styles.contactBtn} href="../../public/assets/Resume/HARSH_KUMAR_2101220CS.pdf" download>Resume</a>
            </div>
        </div>
